...
mongoose.connect('mongodb://localhost/NodejsDersleri');
...
require(path.join(__dirname, './app_server/routers/managerRoute.js'))(app);//ManagerRoute (Uygulamadaki Tüm Yönlendiriceler) Ekleniyor




http.Server(app).listen(3010); // make server listen on port 80